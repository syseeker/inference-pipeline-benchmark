...
| [docs/contention.md](docs/contention.md) | Multi-model GPU sharing — what a degradation ratio means, why the baseline is the hard part, and the single- and multi-GPU topologies |
